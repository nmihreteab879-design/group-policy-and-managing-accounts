...
This project focuses on core identity-security operations inside an Active Directory environment. Instead of documenting every click, this write-up highlights the practical security tasks that IT support and system administrators perform daily—configuring lockout policies, analyzing authentication logs, managing disabled accounts, and restoring user access.
